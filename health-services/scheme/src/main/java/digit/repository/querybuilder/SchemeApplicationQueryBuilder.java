...
public class SchemeApplicationQueryBuilder {
    ...
    private static final String FROM_TABLES = " FROM eg_sch_registration btr  ";

    private final String ORDERBY_CREATEDTIME = " ORDER BY btr.createdtime DESC ";

    public String getApplicationSearchQuery(SchemeApplicationSearchCriteria criteria, List<Object> preparedStmtList){
