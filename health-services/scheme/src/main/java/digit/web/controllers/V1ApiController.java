...
public class V1ApiController {
    ...
    public ResponseEntity<SchemeRegistrationResponse> v1RegistrationUpdatePost(@ApiParam(value = "Details for the new (s) + RequestInfo meta data.", required = true) @Valid @RequestBody SchemeRequest schemeRequest) {
        ...
        public ResponseEntity<SchemeRegistrationResponse> v1SchemeSearchPost (@RequestBody RequestInfoWrapper
        requestInfoWrapper, @Valid @ModelAttribute SchemeApplicationSearchCriteria schemeApplicationSearchCriteria){
